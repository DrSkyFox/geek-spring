...
import ru.chatclient.AuthException;
...
import static ru.chatclient.MessagePatterns.AUTH_FAIL_RESPONSE;
import static ru.chatclient.MessagePatterns.AUTH_SUCCESS_RESPONSE;
...
public class ChatServer {
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            while (true) {
                ...
                if (user != null && authService.authUser(user)) {
                    System.out.printf("ru.chatserver.persists.User %s authorized successful!%n", user.getLogin());
    ...
    private User checkAuthentication(String authMessage) throws AuthException {
        ...
        if (authParts.length != 3 || !authParts[0].equals("/ru/chatserver/auth")) {
    ...
    public void sendMessage(TextMessage msg) throws IOException {
        ...
        if (userToClientHandler != null) {
            ...
            System.out.printf("ru.chatserver.persists.User %s not connected%n", msg.getUserTo());
        }
    }
